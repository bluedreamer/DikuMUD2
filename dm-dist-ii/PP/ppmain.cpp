				...
				switch((int) *s2)
					...
					case '9':
						...
						sbind("__STDC__",one_string,
							NO_PARAMS);
#if	EMBEDDED_EXT
						sbind("__STDC_HOSTED__",
							zero_string,NO_PARAMS);
#else	/* !EMBEDDED_EXT */
						sbind("__STDC_HOSTED__",
							one_string,NO_PARAMS);
#endif	/* EMBEDDED_EXT */
						sbind("__STDC_VERSION__",
							iso_version,NO_PARAMS);
#if	C99_FP
						sbind("__STDC_IEC_559__",
							one_string,NO_PARAMS);
#endif	/* C99_FP */
#if	C99_COMPLEX
						sbind("__STDC_IEC_559_COMPLEX__",
							one_string,NO_PARAMS);
#endif	/* C99_COMPLEX */
#if	C99_WCHAR
						sbind("__STDC_ISO_10646__",
							iso_date,NO_PARAMS);
#endif	/* C99_WCHAR */
						pragopt(EMPTY,FALSE,
							"trigraph");
...
/* Do #func */					(void) (*(sp->pp_func))
						    (sp->pp_arg,0,""); //MS2020 add missing params??? Totally odd.
						}
					}
