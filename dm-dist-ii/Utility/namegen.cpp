   ...
   {
      {
         ...
         {"Ni", "Ten", "Pa", "Fi", "Ra", "Ar", "Mor", "Ny", "Bi",  "Oti", "El", "Ga",  "Za", "Qui",
          "Or", "As",  "Ti", "Zo", "Ne", "Er", "Cha", "Cu", "Wel", "Ir",  "Nu", "Nam", "Ja", "Ma",
          "U",  "Akh", "An", "De", "Ol", "Jo", "Y",   "Ha", "",    "",    "",   ""}, /* Wizard like names - midfixes */
         {"sto", "ser", "fa",  "min", "po", "den", "don", "dan", "din", "he",  "fe",  "qa",  "thus", "the",
          "do",  "fi",  "tor", "kai", "'",  "-",   "za",  "xa",  "fyl", "zyn", "lo",  "hi",  "ta",   "ti",
          "zon", "yar", "di",  "zo",  "ra", "te",  "mo",  "cro", "no",  "mi",  "stu", "stan"}, /* Wizard like names - surfixes */
         {"lus",  "les", "ser",  "nen",  "el",  "lin",  "tra", "ster", "mus", "mis", "alf",  "gast", "gist", "man",
          "ron",  "don", "mort", "star", "ban", "staz", "vix", "ul",   "as",  "cus", "deus", "li",   "ac",   "con",
          "roth", "zir", "tar",  "gul",  "zak", "son",  "zen", "fax",  "fox", "vil", "win",  "dow"},
         0,
         4 /* From 0 to 4 midfixes for Wizard like names */
      },
      {
         /* Dwarf like names - prefixes */
         {"Dwa", "Ba", "Tho", "Do", "No", "Fi", "Ki",  "Bi",  "Bo",  "Kao", "Dwi", "Du",  "Nu", "O",
          "Lo",  "Mo", "Ko",  "Bu", "Fu", "Mu", "Dwo", "Thi", "Thu", "Tha", "Bru", "Dru", "Za", "Zi",
          "Zo",  "Mi", "",    "",   "",   "",   "",    "",    "",    "",    "",    ""}, /* Dwarf like names - midfixes */
         {"m", "l", "r", "f", "b", "k", "d", "n", "g", "t", "", "", "", "", "", "", "", "", "", "",
          "",  "",  "",  "",  "",  "",  "",  "",  "",  "",  "", "", "", "", "", "", "", "", "", ""}, /* Dwarf like names - surfixes */
         {"in", "ar", "i", "or", "ur", "a", "ir", "iz", "er", "", "", "", "", "", "", "", "", "", "", "",
          "",   "",   "",  "",   "",   "",  "",   "",   "",   "", "", "", "", "", "", "", "", "", "", ""},
         1,
         1 /* Always one midfix for Dwarf like names */
      },
      {
         /* Elf like names - prefixes */
         {"Le", "Ga", "Lau", "A", "Si", "Ce", "E", "Fa", "Go", "Is", "", "", "", "", "", "", "", "", "", "", "",
          "",   "",   "",    "",  "",   "",   "",  "",   "",   "",   "", "", "", "", "", "", "", "", ""}, /* Elf like names - midfixes */
         {"lo", "la", "le", "li", "ho", "ha", "he", "hi", "", "", "ro", "ra", "re", "ri", "mo", "ma", "me", "mi", "", "", "go",
          "ga", "ge", "gi", "",   "",   "",   "",   "",   "", "", "",   "",   "",   "",   "",   "",   "",   "",   ""}, /* Elf like names -
                                                                                                                          surfixes */
         {"las", "driel", "na", "kiel", "mir", "on", "os", "as", "el", "es", "en", "th", "n", "r", "lan", "", "", "", "", "",
          "",    "",      "",   "",     "",    "",   "",   "",   "",   "",   "",   "",   "",  "",  "",    "", "", "", "", ""},
         1,
         2 /* From one to two midfixes for Elf like names */
      }};
