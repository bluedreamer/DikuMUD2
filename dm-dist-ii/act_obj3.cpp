...
auto wear(unit_data *ch, unit_data *obj, int keyword, bool err, const command_info *cmd, char *arg) -> bool
{
   ...
   {
      case WEAR_UNUSED:
         if(equipment(ch, WEAR_UNUSED) != nullptr)
         {
      ...
      case WEAR_FINGER_L:
         ...
         else if(equipment(ch, WEAR_FINGER_L) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n is $2t to fit your finger.", A_ALWAYS, ch, c, obj, TO_CHAR);
               return FALSE;
            }
            unit_messg(ch, obj, "$wear", "You put $2n on your left hand's ringfinger.", "$1n puts $2n on $1s left hand's ringfinger.");
            equip_char(ch, obj, WEAR_FINGER_L);
         }
         else if(equipment(ch, WEAR_FINGER_R) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n is $2t to fit your finger.", A_ALWAYS, ch, c, obj, TO_CHAR);
            ...
            unit_messg(ch, obj, "$wear", "You put $2n on your right hand's ringfinger.", "$1n puts $2n on $1s right hand's ringfinger.");
      ...
      case WEAR_NECK_2:
         ...
         else if(equipment(ch, WEAR_NECK_1) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n is $2t to fit around your neck.", A_ALWAYS, ch, c, obj, TO_CHAR);
               return FALSE;
            }
            unit_messg(ch, obj, "$wear", "You wear $2n around your neck.", "$1n wears $2n around $1s neck.");
            equip_char(ch, obj, WEAR_NECK_1);
         }
         else if(equipment(ch, WEAR_NECK_2) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n is $2t to fit around your neck.", A_ALWAYS, ch, c, obj, TO_CHAR);
      ...
      case WEAR_BODY:
         ...
         else if(equipment(ch, WEAR_BODY) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n is $2t to fit your body.", A_ALWAYS, ch, c, obj, TO_CHAR);
               return FALSE;
            }
            unit_messg(ch, obj, "$wear", "You put $2n on your body.", "$1n puts $2n on $1s body.");
      ...
      case WEAR_HEAD:
         ...
         else if(equipment(ch, WEAR_HEAD) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n is $2t to fit your head.", A_ALWAYS, ch, c, obj, TO_CHAR);
               return FALSE;
            }
            unit_messg(ch, obj, "$wear", "You wear $2n on your head.", "$1n wears $2n on $1s head.");
      ...
      case WEAR_LEGS:
         ...
         else if(equipment(ch, WEAR_LEGS) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n are $2t to fit your legs.", A_ALWAYS, ch, c, obj, TO_CHAR);
               return FALSE;
            }
            unit_messg(ch, obj, "$wear", "You put $2n on your legs.", "$1n puts $2n on $1s legs.");
      ...
      case WEAR_FEET:
         ...
         else if(equipment(ch, WEAR_FEET) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n are $2t to fit your feet.", A_ALWAYS, ch, c, obj, TO_CHAR);
               return FALSE;
            }
            unit_messg(ch, obj, "$wear", "You put $2n on your feet.", "$1n puts $2n on $1s feet.");
      ...
      case WEAR_HANDS:
         ...
         else if(equipment(ch, WEAR_HANDS) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n are $2t to fit your hands.", A_ALWAYS, ch, c, obj, TO_CHAR);
               return FALSE;
            }
            unit_messg(ch, obj, "$wear", "You start using $2n.", "$1n starts using $2n.");
      ...
      case WEAR_ARMS:
         ...
         else if(equipment(ch, WEAR_ARMS) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n are $2t to fit your arms.", A_ALWAYS, ch, c, obj, TO_CHAR);
               return FALSE;
            }
            unit_messg(ch, obj, "$wear", "You wear $2n on your arms.", "$1n wears $2n on $1s arms.");
      ...
      case WEAR_ABOUT:
         ...
         else if(equipment(ch, WEAR_ABOUT) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n is $2t to fit about your body.", A_ALWAYS, ch, c, obj, TO_CHAR);
               return FALSE;
            }
            unit_messg(ch, obj, "$wear", "You wrap $2n about your body.", "$1n wraps $2n about $1s body.");
      ...
      case WEAR_WAIST:
         ...
         else if(equipment(ch, WEAR_WAIST) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n is $2t to fit around your waist.", A_ALWAYS, ch, c, obj, TO_CHAR);
               return FALSE;
            }
            unit_messg(ch, obj, "$wear", "You strap $2n about your waist.", "$1n straps $2n about $1s waist.");
      ...
      case WEAR_WRIST_R:
         ...
         else if(equipment(ch, WEAR_WRIST_L) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n is $2t to fit around your wrist.", A_ALWAYS, ch, c, obj, TO_CHAR);
               return FALSE;
            }
            unit_messg(ch, obj, "$wear", "You wear $2n around your left wrist.", "$1n wears $2n around $1s left wrist.");
            equip_char(ch, obj, WEAR_WRIST_L);
         }
         else if(equipment(ch, WEAR_WRIST_R) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n is $2t to fit around your wrist.", A_ALWAYS, ch, c, obj, TO_CHAR);
            ...
            unit_messg(ch, obj, "$wear", "You wear $2n around your right wrist.", "$1n wears $2n around $1s right wrist.");
      ...
      case WEAR_WIELD:
         ...
         else if((object_two_handed(obj) != 0) && hands_used(ch) > 0)
         {
            errstr = "You need two free hands to wield this weapon.";
         }
         else if(equipment(ch, WEAR_WIELD) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n is $2t to be wielded by you.", A_ALWAYS, ch, c, obj, TO_CHAR);
               return FALSE;
            }
            if(object_two_handed(obj) != 0)
            {
               unit_messg(ch, obj, "$wear", "You wield $2n two-handedly.", "$1n wields $2n two-handedly.");
            }
            else
            {
               unit_messg(ch, obj, "$wear", "You wield $2n.", "$1n wields $2n.");
            }
      ...
      case WEAR_HOLD:
         ...
         else if(equipment(ch, WEAR_HOLD) == nullptr)
         {
            if((object_two_handed(obj) != 0) && hands_used(ch) > 0)
            {
            ...
            unit_messg(ch, obj, "$wear", "You start holding $2n.", "$1n starts holding $2n.");
      ...
      case WEAR_SHIELD:
         ...
         else if(equipment(ch, WEAR_SHIELD) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n are $2t to fit your arms.", A_ALWAYS, ch, c, obj, TO_CHAR);
            ...
            unit_messg(ch, obj, "$wear", "You strap $2n to your arm.", "$1n straps $2n on $1s arm.");
      ...
      case WEAR_CHEST:
         ...
         else if(equipment(ch, WEAR_CHEST) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n is $2t to fit your chest.", A_ALWAYS, ch, c, obj, TO_CHAR);
               return FALSE;
            }

            unit_messg(ch, obj, "$wear", "You strap $2n across your chest.", "$1n straps $2n across $1s chest.");
      ...
      case WEAR_BACK:
         ...
         else if(equipment(ch, WEAR_BACK) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n is $2t to fit on your back.", A_ALWAYS, ch, c, obj, TO_CHAR);
               return FALSE;
            }

            unit_messg(ch, obj, "$wear", "You strap $2n on your back.", "$1n straps $2n around $1s back.");
      ...
      case WEAR_EAR_R:
         ...
         else if(equipment(ch, WEAR_EAR_L) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n is $2t to fit your ear.", A_ALWAYS, ch, c, obj, TO_CHAR);
               return FALSE;
            }

            unit_messg(ch, obj, "$wear", "You wear $2n on your left ear.", "$1n wears $2n on $1s left ear.");
            equip_char(ch, obj, WEAR_EAR_L);
         }
         else if(equipment(ch, WEAR_EAR_R) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n is $2t to fit your ear.", A_ALWAYS, ch, c, obj, TO_CHAR);
            ...
            unit_messg(ch, obj, "$wear", "You wear $2n on your right ear.", "$1n wears $2n on $1s right ear.");
      ...
      case WEAR_ANKLE_R:
         ...
         else if(equipment(ch, WEAR_ANKLE_L) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n is $2t to fit your ankle.", A_ALWAYS, ch, c, obj, TO_CHAR);
               return FALSE;
            }

            unit_messg(ch, obj, "$wear", "You wear $2n around your left ankle.", "$1n wears $2n around $1s left ankle.");
            equip_char(ch, obj, WEAR_ANKLE_L);
         }
         else if(equipment(ch, WEAR_ANKLE_R) == nullptr)
         {
            if((c = obj_wear_size(ch, obj, keyword)) != nullptr)
            {
               act("$3n is $2t to fit your ankle.", A_ALWAYS, ch, c, obj, TO_CHAR);
            ...
            unit_messg(ch, obj, "$wear", "You wear $2n around your right ankle.", "$1n wears $2n around $1s right ankle.");
   ...
   if(errstr == nullptr)
   {
      send_done(ch, obj, nullptr, 0, cmd, arg);
      return TRUE;
   }

   if(err)
   {
      act(errstr, A_SOMEONE, ch, obj, nullptr, TO_CHAR);
   }
   return FALSE;
}
...
void do_wear(unit_data *ch, char *arg, const command_info *cmd)
{
   ...
   else if((obj = find_unit(ch, &arg, nullptr, FIND_UNIT_INVEN)) == nullptr)
   {
      ...
      if(strcmp(buf, "all") == 0)
      {
         ...
         for(obj = UNIT_CONTAINS(ch); obj != nullptr; obj = next)
         {
            if(UNIT_IN(obj) != ch)
            {
               ...
               act("You stop wearing all, it seems unsafe.", A_SOMEONE, ch, nullptr, nullptr, TO_CHAR);
               break;
            }
         ...
         if(!worn)
         {
            act("You have nothing to wear.", A_SOMEONE, ch, nullptr, nullptr, TO_CHAR);
         }
      }
      else
      {
   ...
   else if(static_cast<unsigned int>(str_is_empty(arg)) == 0U)
   {
      ...
      if(keyword == -1)
      {
         act("$2t is an unknown body location.", A_SOMEONE, ch, buf, nullptr, TO_CHAR);
      }
      else
      {
...
auto remove_equip(unit_data *ch, unit_data *obj, const command_info *cmd, char *arg) -> bool
{
   ...
   {
      act("The $3N is cursed, you can't remove it!", A_SOMEONE, ch, nullptr, obj, TO_CHAR);
      act("$1n tries to get rid of $3n, but in vain!", A_HIDEINV, ch, nullptr, obj, TO_ROOM);
      return FALSE;
   }
...
void do_remove(unit_data *ch, char *arg, const command_info *cmd)
{
   ...
   else if((obj = find_unit(ch, &arg, nullptr, FIND_UNIT_EQUIP)) == nullptr)
   {
      char buf[MAX_INPUT_LENGTH];
      ...
      if(strcmp(buf, "all") == 0)
      {
         ...
         for(obj = UNIT_CONTAINS(ch); obj != nullptr; obj = next)
         {
            ...
            {
               // Each iteration can cause illegal lists.
               act("You stop removing all, it seems unsafe.", A_SOMEONE, ch, nullptr, nullptr, TO_CHAR);
               break;
            }
         ...
         if(!removed)
         {
            act("There was nothing to remove.", A_SOMEONE, ch, nullptr, nullptr, TO_CHAR);
         }
      }
      else
      {
