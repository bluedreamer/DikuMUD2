...
struct unit_function_array_type unit_function_array[] = {
   ...
   {"protect lawful", protect_lawful, SD_NULL, SFB_COM | SFB_DEAD | SFB_TICK, PULSE_SEC * 15},
   {"P.A.I.N.", pain_exec, SD_NEVER, SFB_CMD | SFB_TICK, PULSE_SEC * 15},
   {"P.A.I.N. Init", pain_init, SD_ASCII, SFB_CMD | SFB_TICK, PULSE_SEC * 1},
   {"npc visit room", npc_visit_room, SD_NEVER, SFB_TICK | SFB_PRIORITY, PULSE_SEC * 5},
   {"mercenary hire", mercenary_hire, SD_NULL, SFB_CMD, 0},
   {"mercenary hunt", mercenary_hunt, SD_NEVER, SFB_TICK | SFB_DEAD, PULSE_SEC * 10},
