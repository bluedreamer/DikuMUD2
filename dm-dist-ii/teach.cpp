...
static auto gold_cost(skill_teach_type *s, int level) -> int
{
   if(level < 1)
   {
...
auto teaches_index(skill_teach_type *teaches_skills, int node) -> int
{
   int i;
...
auto teach_basis(spec_arg *sarg, teach_packet *pckt) -> int
{
   int      index;
   int      stop;
