...
void tif_confusion_tick(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
...
void tif_invisibility_off(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   if(!IS_SET(UNIT_FLAGS(unit), UNIT_FL_INVISIBLE))
   {
...
void tif_blind_on(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   send_to_char("A cloak of darkness falls around you.\n\r", unit);
}

void tif_blind_off(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   send_to_char("The veil of darkness disappears.\n\r", unit);
}

/* sneak */
void tif_sneak_on(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   send_to_char("Ok, you'll try to move silently for a while.\n\r", unit);
}

void tif_sneak_off(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   send_to_char("You stop sneaking about.\n\r", unit);
}

void tif_sneak_tick(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   send_to_char("You sneak about unnoticed.\n\r", unit);
}

/* hide */
void tif_hide_on(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   send_to_char("You try to hide yourself.\n\r", unit);
}

void tif_hide_off(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
...
void tif_nohide_tick(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   if(!(af->data[1]))
      return;
...
/* bless */
void tif_bless_on(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   send_to_char("You feel divine forces helping you.\n\r", unit);
}

void tif_bless_off(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   send_to_char("You feel divine forces abandoning you.\n\r", unit);
}

void tif_bless_tick(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   if(af->duration == 1)
...
/* curse */
void tif_curse_on(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   if(IS_CHAR(unit))
...
void tif_sanctuary_tick(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   if(af->duration == 1)
   {
...
void tif_eyes_tingle(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   send_to_char("Your eyes begin to tingle.\n\r", unit);
}

void tif_torch_tick(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   OBJ_VALUE(unit, 0)--;
...
void tif_light_add(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   if(!UNIT_IN(unit))
      return;
...
void tif_sleep_check(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   int hm;
...
void tif_str_off(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   af->data[1] = -af->data[1];
   tif_str_on(af, unit);
   af->data[1] = -af->data[1];
...
void tif_poison_suffer(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
...
/* plague */
void tif_plague_on(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   send_to_char("You suddenly feel very sick.\n\r", unit);
}

void tif_plague_tick(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
}

void tif_plague_off(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
...
void tif_prot_good_on(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   send_to_char("You feel protected from the forces of good.\n\r", unit);
}

void tif_prot_evil_off(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   send_to_char("You feel less protected from the forces of evil.\n\r", unit);
}

void tif_prot_good_off(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   send_to_char("You feel less protected from the forces of good.\n\r", unit);
}

void tif_sustain_on(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   send_to_char("You feel sustained.\n\r", unit);
}

void tif_sustain_tick(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   if(!IS_PC(unit))
      return;
...
void tif_sustain_off(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   send_to_char("You no longer feel sustained.\n\r", unit);
}

void tif_decay_corpse(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
...
void tif_buried_destruct(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   if(IS_SET(UNIT_FLAGS(unit), UNIT_FL_BURIED))
   {
...
void tif_valhalla_ret(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
   if(!IS_PC(unit))
      return;
...
void tif_jail_wait(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
}

/* Get thrown out of jail */
void tif_jail_release(struct unit_affected_type *af, std::shared_ptr<unit_data> unit)
{
}
