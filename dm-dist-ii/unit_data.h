...
public:
   ...
   unit_data          *outside; /* Pointer out of the unit, ei. from an object    out to the char carrying it                   */
   unit_data          *inside;  /* Linked list of chars,rooms & objs              For next unit in 'inside' linked list         */
   unit_data          *next;
